...
def module_node_group():
    ...
    geometry_socket = module.interface.new_socket(
        name="Geometry", in_out="OUTPUT", socket_type="NodeSocketGeometry"
    )
    geometry_socket.attribute_domain = "POINT"

    module_centering_socket = module.interface.new_socket(
    ...
    module_size_socket = module.interface.new_socket(
    ...
    module_thickness_socket = module.interface.new_socket(
    ...
    module_size_tolerance_socket = module.interface.new_socket(
    ...
    module_count_x_socket = module.interface.new_socket(
    ...
    module_count_y_socket = module.interface.new_socket(
    ...
    holes_enable_socket = module.interface.new_socket(
    ...
    holes_vertices_socket = module.interface.new_socket(
    ...
    holes_offset_from_corner_socket = module.interface.new_socket(
    ...
    holes_diameter_socket = module.interface.new_socket(
