...
def asteroid_node_group():
    ...
    geometry_socket = asteroid.interface.new_socket(
        name="geometry", in_out="OUTPUT", socket_type="NodeSocketGeometry"
    )
    geometry_socket.attribute_domain = "POINT"

    seed_socket_2 = asteroid.interface.new_socket(
        name="seed", in_out="INPUT", socket_type="NodeSocketInt"
    )
    ...
    detail_socket = asteroid.interface.new_socket(
    ...
    scale_socket = asteroid.interface.new_socket(
    ...
    scale_std_socket = asteroid.interface.new_socket(
    ...
    mat_socket = asteroid.interface.new_socket(
    ...
    float_curve_curve_0_point_2 = float_curve_curve_0.points.new(
        0.6500000953674316, 0.8874998092651367
    )
