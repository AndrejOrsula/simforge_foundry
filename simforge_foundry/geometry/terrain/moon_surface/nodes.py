...
def moonsurface_node_group():
    ...
    moonsurface.description = ""
    moonsurface.default_group_node_width = 140

    moonsurface.is_modifier = True

    geometry_socket_1 = moonsurface.interface.new_socket(
        name="geometry", in_out="OUTPUT", socket_type="NodeSocketGeometry"
    )
    geometry_socket_1.attribute_domain = "POINT"

    seed_socket_4 = moonsurface.interface.new_socket(
        name="seed", in_out="INPUT", socket_type="NodeSocketInt"
    )
    ...
    scale_socket_1 = moonsurface.interface.new_socket(
        name="scale", in_out="INPUT", socket_type="NodeSocketVector"
    )
    ...
    density_socket = moonsurface.interface.new_socket(
    ...
    flat_area_size_socket = moonsurface.interface.new_socket(
    ...
    rock_mesh_boolean_enable_socket = moonsurface.interface.new_socket(
    ...
    mat_socket = moonsurface.interface.new_socket(
    ...
    distribute_points_on_faces = moonsurface.nodes.new(
    ...
    distribute_points_on_faces_001 = moonsurface.nodes.new(
        "GeometryNodeDistributePointsOnFaces"
    )
