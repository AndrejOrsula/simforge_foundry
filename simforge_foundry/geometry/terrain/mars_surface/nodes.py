...
def rock_node_group():
    ...
    geometry_socket = rock.interface.new_socket(
        name="geometry", in_out="OUTPUT", socket_type="NodeSocketGeometry"
    )
    geometry_socket.attribute_domain = "POINT"

    seed_socket_2 = rock.interface.new_socket(
        name="seed", in_out="INPUT", socket_type="NodeSocketInt"
    )
    ...
    detail_socket = rock.interface.new_socket(
        name="detail", in_out="INPUT", socket_type="NodeSocketInt"
    )
    ...
    scale_socket = rock.interface.new_socket(
    ...
    scale_std_socket = rock.interface.new_socket(
        name="scale_std", in_out="INPUT", socket_type="NodeSocketVector"
    )
    ...
    horizontal_cut_enable_socket = rock.interface.new_socket(
        name="horizontal_cut_enable", in_out="INPUT", socket_type="NodeSocketBool"
    )
    ...
    horizontal_cut_offset_socket = rock.interface.new_socket(
        name="horizontal_cut_offset", in_out="INPUT", socket_type="NodeSocketFloat"
    )
    ...
    mat_socket = rock.interface.new_socket(
        name="mat", in_out="INPUT", socket_type="NodeSocketMaterial"
    )
...
def crater_profile_node_group():
    ...
    math_001_1.label = "Metric radius"
...
def marssurface_node_group():
    ...
    marssurface.description = ""
    marssurface.default_group_node_width = 140

    marssurface.is_modifier = True

    geometry_socket_1 = marssurface.interface.new_socket(
        name="geometry", in_out="OUTPUT", socket_type="NodeSocketGeometry"
    )
    geometry_socket_1.attribute_domain = "POINT"

    seed_socket_4 = marssurface.interface.new_socket(
        name="seed", in_out="INPUT", socket_type="NodeSocketInt"
    )
    ...
    scale_socket_1 = marssurface.interface.new_socket(
        name="scale", in_out="INPUT", socket_type="NodeSocketVector"
    )
    ...
    density_socket = marssurface.interface.new_socket(
    ...
    flat_area_size_socket = marssurface.interface.new_socket(
        name="flat_area_size", in_out="INPUT", socket_type="NodeSocketFloat"
    )
    ...
    rock_mesh_boolean_enable_socket = marssurface.interface.new_socket(
        name="rock_mesh_boolean_enable", in_out="INPUT", socket_type="NodeSocketBool"
    )
    ...
    mat_socket_1 = marssurface.interface.new_socket(
        name="mat", in_out="INPUT", socket_type="NodeSocketMaterial"
    )
    ...
    distribute_points_on_faces = marssurface.nodes.new(
    ...
    distribute_points_on_faces_001 = marssurface.nodes.new(
        "GeometryNodeDistributePointsOnFaces"
    )
