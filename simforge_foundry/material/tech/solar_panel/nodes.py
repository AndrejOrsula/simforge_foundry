...
def solarpanelmat_node_group():
    ...
    group_1.inputs[0].default_value = (
        0.0013056989992037416,
        0.012050267308950424,
        0.1727084219455719,
        1.0,
    )
    group_1.inputs[1].default_value = (
        0.0027601474430412054,
        0.0037171675357967615,
        0.1186249703168869,
        1.0,
