...
def solarcellshader_node_group():
    solarcellshader = bpy.data.node_groups.new(
        type="ShaderNodeTree", name="SolarCellShader"
    )
    ...
    shader_socket = solarcellshader.interface.new_socket(
        name="Shader", in_out="OUTPUT", socket_type="NodeSocketShader"
    )
    shader_socket.attribute_domain = "POINT"

    scale_socket = solarcellshader.interface.new_socket(
    ...
    color1_socket = solarcellshader.interface.new_socket(
    ...
    color2_socket = solarcellshader.interface.new_socket(
    ...
    grid_visibility_socket = solarcellshader.interface.new_socket(
        name="grid_visibility", in_out="INPUT", socket_type="NodeSocketFloat"
    )
    ...
    roughness_socket = solarcellshader.interface.new_socket(
    ...
    bump_strength_socket = solarcellshader.interface.new_socket(
        name="bump_strength", in_out="INPUT", socket_type="NodeSocketFloat"
    )
