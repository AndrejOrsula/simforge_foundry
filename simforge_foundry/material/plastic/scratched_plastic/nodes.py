...
def scratchedplasticshader_node_group():
    scratchedplasticshader = bpy.data.node_groups.new(
        type="ShaderNodeTree", name="ScratchedPlasticShader"
    )
    ...
    shader_socket = scratchedplasticshader.interface.new_socket(
        name="Shader", in_out="OUTPUT", socket_type="NodeSocketShader"
    )
    shader_socket.attribute_domain = "POINT"

    scale_socket = scratchedplasticshader.interface.new_socket(
    ...
    plastic_color_socket = scratchedplasticshader.interface.new_socket(
        name="Plastic Color", in_out="INPUT", socket_type="NodeSocketColor"
    )
    plastic_color_socket.default_value = (
    ...
    subsurface_socket = scratchedplasticshader.interface.new_socket(
        name="Subsurface", in_out="INPUT", socket_type="NodeSocketFloat"
    )
    ...
    roughness_socket = scratchedplasticshader.interface.new_socket(
    ...
    noise_roughness_scale_socket = scratchedplasticshader.interface.new_socket(
        name="Noise Roughness Scale", in_out="INPUT", socket_type="NodeSocketFloat"
    )
    ...
    noise_roughness_detail_socket = scratchedplasticshader.interface.new_socket(
        name="Noise Roughness Detail", in_out="INPUT", socket_type="NodeSocketFloat"
    )
    ...
    scratches_color_socket = scratchedplasticshader.interface.new_socket(
    ...
    scratches_detail_socket = scratchedplasticshader.interface.new_socket(
        name="Scratches Detail", in_out="INPUT", socket_type="NodeSocketFloat"
    )
    ...
    scratches_distortion_socket = scratchedplasticshader.interface.new_socket(
        name="Scratches Distortion", in_out="INPUT", socket_type="NodeSocketFloat"
    )
    ...
    scratches_scale_1_socket = scratchedplasticshader.interface.new_socket(
        name="Scratches Scale 1", in_out="INPUT", socket_type="NodeSocketFloat"
    )
    ...
    scratches_thickness_1_socket = scratchedplasticshader.interface.new_socket(
        name="Scratches Thickness 1", in_out="INPUT", socket_type="NodeSocketFloat"
    )
    ...
    scratches_scale_2_socket = scratchedplasticshader.interface.new_socket(
        name="Scratches Scale 2", in_out="INPUT", socket_type="NodeSocketFloat"
    )
    ...
    scratches_thickness_2_socket = scratchedplasticshader.interface.new_socket(
        name="Scratches Thickness 2", in_out="INPUT", socket_type="NodeSocketFloat"
    )
    ...
    scratches_bump_strength_socket = scratchedplasticshader.interface.new_socket(
    ...
    noise_bump_strength_socket = scratchedplasticshader.interface.new_socket(
    ...
    hue_saturation_value_003 = scratchedplasticshader.nodes.new(
    ...
    hue_saturation_value_004 = scratchedplasticshader.nodes.new(
        "ShaderNodeHueSaturation"
    )
    ...
    hue_saturation_value_005 = scratchedplasticshader.nodes.new(
        "ShaderNodeHueSaturation"
    )
    ...
    scratchedplasticshader.links.new(
        mapping_001.outputs[0], noise_texture_002.inputs[0]
    )
    ...
    scratchedplasticshader.links.new(
        magic_texture_003.outputs[0], hue_saturation_value_004.inputs[4]
    )
    scratchedplasticshader.links.new(bump_003.outputs[0], principled_bsdf_001.inputs[5])
    scratchedplasticshader.links.new(
        color_ramp_005.outputs[0], hue_saturation_value_005.inputs[4]
    )
    scratchedplasticshader.links.new(mix_003.outputs[2], magic_texture_003.inputs[0])
    scratchedplasticshader.links.new(
        hue_saturation_value_004.outputs[0], color_ramp_004.inputs[0]
    )
    scratchedplasticshader.links.new(mix_004.outputs[2], bump_002.inputs[2])
    scratchedplasticshader.links.new(
        hue_saturation_value_005.outputs[0], principled_bsdf_001.inputs[2]
    )
    ...
    scratchedplasticshader.links.new(
        magic_texture_002.outputs[0], hue_saturation_value_003.inputs[4]
    )
    scratchedplasticshader.links.new(
        noise_texture_003.outputs[0], color_ramp_005.inputs[0]
    )
    scratchedplasticshader.links.new(
        texture_coordinate_001.outputs[3], mapping_001.inputs[0]
    )
    scratchedplasticshader.links.new(
        reroute_001.outputs[0], noise_texture_003.inputs[0]
    )
    scratchedplasticshader.links.new(mapping_001.outputs[0], reroute_001.inputs[0])
    scratchedplasticshader.links.new(
        hue_saturation_value_003.outputs[0], color_ramp_003.inputs[0]
    )
    scratchedplasticshader.links.new(
        principled_bsdf_001.outputs[0], group_output.inputs[0]
    )
    ...
    scratchedplasticshader.links.new(
        group_input.outputs[2], principled_bsdf_001.inputs[8]
    )
    scratchedplasticshader.links.new(
        group_input.outputs[3], hue_saturation_value_005.inputs[2]
    )
    scratchedplasticshader.links.new(
        group_input.outputs[4], noise_texture_003.inputs[2]
    )
    scratchedplasticshader.links.new(
        group_input.outputs[5], noise_texture_003.inputs[3]
    )
    scratchedplasticshader.links.new(group_input.outputs[6], mix_005.inputs[6])
    scratchedplasticshader.links.new(
        group_input.outputs[7], noise_texture_002.inputs[3]
    )
    scratchedplasticshader.links.new(group_input.outputs[8], mix_003.inputs[0])
    scratchedplasticshader.links.new(
        group_input.outputs[9], magic_texture_002.inputs[1]
    )
    scratchedplasticshader.links.new(
        group_input.outputs[10], hue_saturation_value_003.inputs[2]
    )
    scratchedplasticshader.links.new(
        group_input.outputs[11], magic_texture_003.inputs[1]
    )
    scratchedplasticshader.links.new(
        group_input.outputs[12], hue_saturation_value_004.inputs[2]
    )
