...
def moonrockshader_node_group():
    moonrockshader = bpy.data.node_groups.new(
        type="ShaderNodeTree", name="MoonRockShader"
    )
    ...
    bsdf_socket_1 = moonrockshader.interface.new_socket(
        name="BSDF", in_out="OUTPUT", socket_type="NodeSocketShader"
    )
    bsdf_socket_1.attribute_domain = "POINT"

    scale_socket_4 = moonrockshader.interface.new_socket(
        name="scale", in_out="INPUT", socket_type="NodeSocketFloat"
    )
    ...
    color1_socket = moonrockshader.interface.new_socket(
        name="color1", in_out="INPUT", socket_type="NodeSocketColor"
    )
    color1_socket.default_value = (
        0.24619978666305542,
        0.24620160460472107,
        0.2462015002965927,
        1.0,
    ...
    color2_socket = moonrockshader.interface.new_socket(
        name="color2", in_out="INPUT", socket_type="NodeSocketColor"
    )
    color2_socket.default_value = (
        0.005181482061743736,
        0.005181520711630583,
        0.005181518383324146,
        1.0,
    )
    color2_socket.attribute_domain = "POINT"

    edge_color_socket = moonrockshader.interface.new_socket(
        name="edge_color", in_out="INPUT", socket_type="NodeSocketColor"
    )
    edge_color_socket.default_value = (
        0.4000000059604645,
        0.4000000059604645,
        0.4000000059604645,
        1.0,
    ...
    noise_scale_socket_2 = moonrockshader.interface.new_socket(
        name="noise_scale", in_out="INPUT", socket_type="NodeSocketFloat"
    )
    ...
    noise_detail_socket = moonrockshader.interface.new_socket(
        name="noise_detail", in_out="INPUT", socket_type="NodeSocketFloat"
    )
    ...
    noise_roughness_socket = moonrockshader.interface.new_socket(
        name="noise_roughness", in_out="INPUT", socket_type="NodeSocketFloat"
    )
    ...
    light_noise_scale_socket = moonrockshader.interface.new_socket(
        name="light_noise_scale", in_out="INPUT", socket_type="NodeSocketFloat"
    )
    ...
    light_noise_roughness_socket = moonrockshader.interface.new_socket(
        name="light_noise_roughness", in_out="INPUT", socket_type="NodeSocketFloat"
    )
    ...
    roughness_socket_4 = moonrockshader.interface.new_socket(
        name="roughness", in_out="INPUT", socket_type="NodeSocketFloat"
    )
    ...
    noise_bump_scale_socket = moonrockshader.interface.new_socket(
        name="noise_bump_scale", in_out="INPUT", socket_type="NodeSocketFloat"
    )
    ...
    noise_bump_strength_socket_2 = moonrockshader.interface.new_socket(
        name="noise_bump_strength", in_out="INPUT", socket_type="NodeSocketFloat"
    )
    ...
    detailed_noise_bump_strength_socket = moonrockshader.interface.new_socket(
        name="detailed_noise_bump_strength",
        in_out="INPUT",
    ...
    edge_color_strength_socket = moonrockshader.interface.new_socket(
        name="edge_color_strength", in_out="INPUT", socket_type="NodeSocketFloat"
    )
    ...
    noise_scale_mixer_socket = moonrockshader.interface.new_socket(
        name="noise_scale_mixer", in_out="INPUT", socket_type="NodeSocketFloat"
    )
    ...
    noise_bump_roughness_socket = moonrockshader.interface.new_socket(
        name="noise_bump_roughness", in_out="INPUT", socket_type="NodeSocketFloat"
    )
    ...
    voronoi_bump_scale_socket = moonrockshader.interface.new_socket(
        name="voronoi_bump_scale", in_out="INPUT", socket_type="NodeSocketFloat"
    )
    ...
    voronoi_bump_strength_socket = moonrockshader.interface.new_socket(
        name="voronoi_bump_strength", in_out="INPUT", socket_type="NodeSocketFloat"
    )
    ...
    group_output_6 = moonrockshader.nodes.new("NodeGroupOutput")
    group_output_6.name = "Group Output"
    group_output_6.is_active_output = True

    group_input_6 = moonrockshader.nodes.new("NodeGroupInput")
    group_input_6.label = "Rock Color 2"
    group_input_6.name = "Group Input"

    noise_texture_4 = moonrockshader.nodes.new("ShaderNodeTexNoise")
    ...
    bump_4 = moonrockshader.nodes.new("ShaderNodeBump")
    bump_4.name = "Bump"
    bump_4.invert = False
    bump_4.inputs[1].default_value = 1.0

    color_ramp_1 = moonrockshader.nodes.new("ShaderNodeValToRGB")
    ...
    noise_texture_001_3 = moonrockshader.nodes.new("ShaderNodeTexNoise")
    ...
    color_ramp_001_2 = moonrockshader.nodes.new("ShaderNodeValToRGB")
    ...
    mix_3 = moonrockshader.nodes.new("ShaderNodeMix")
    mix_3.name = "Mix"
    ...
    mix_001_4 = moonrockshader.nodes.new("ShaderNodeMix")
    ...
    color_ramp_002_2 = moonrockshader.nodes.new("ShaderNodeValToRGB")
    ...
    mix_003_4 = moonrockshader.nodes.new("ShaderNodeMix")
    ...
    color_ramp_004_1 = moonrockshader.nodes.new("ShaderNodeValToRGB")
    ...
    noise_texture_003_1 = moonrockshader.nodes.new("ShaderNodeTexNoise")
    ...
    bump_001_4 = moonrockshader.nodes.new("ShaderNodeBump")
    bump_001_4.name = "Bump.001"
    bump_001_4.invert = False
    bump_001_4.inputs[1].default_value = 1.0

    frame_001_1 = moonrockshader.nodes.new("NodeFrame")
    frame_001_1.name = "Frame.001"
    frame_001_1.label_size = 20
    frame_001_1.shrink = True

    frame_002_1 = moonrockshader.nodes.new("NodeFrame")
    frame_002_1.name = "Frame.002"
    frame_002_1.label_size = 20
    frame_002_1.shrink = True

    frame_1 = moonrockshader.nodes.new("NodeFrame")
    frame_1.name = "Frame"
    frame_1.label_size = 20
    frame_1.shrink = True

    hue_saturation_value_4 = moonrockshader.nodes.new("ShaderNodeHueSaturation")
    ...
    frame_003_1 = moonrockshader.nodes.new("NodeFrame")
    frame_003_1.name = "Frame.003"
    frame_003_1.label_size = 20
    frame_003_1.shrink = True

    principled_bsdf_4 = moonrockshader.nodes.new("ShaderNodeBsdfPrincipled")
    ...
    bump_002_3 = moonrockshader.nodes.new("ShaderNodeBump")
    bump_002_3.name = "Bump.002"
    bump_002_3.invert = False
    bump_002_3.inputs[1].default_value = 1.0

    color_ramp_005_1 = moonrockshader.nodes.new("ShaderNodeValToRGB")
    ...
    voronoi_texture_001_2 = moonrockshader.nodes.new("ShaderNodeTexVoronoi")
    ...
    color_ramp_006_1 = moonrockshader.nodes.new("ShaderNodeValToRGB")
    ...
    bump_003_1 = moonrockshader.nodes.new("ShaderNodeBump")
    ...
    map_range_004_2 = moonrockshader.nodes.new("ShaderNodeMapRange")
    ...
    moonrockshader.links.new(mapping_001_2.outputs[0], noise_texture_001_3.inputs[0])
    moonrockshader.links.new(noise_texture_001_3.outputs[0], color_ramp_001_2.inputs[0])
    moonrockshader.links.new(color_ramp_001_2.outputs[0], mix_3.inputs[7])
    moonrockshader.links.new(
        color_ramp_004_1.outputs[0], hue_saturation_value_4.inputs[4]
    )
    moonrockshader.links.new(mix_001_4.outputs[2], mix_003_4.inputs[6])
    moonrockshader.links.new(mix_003_4.outputs[2], principled_bsdf_4.inputs[0])
    moonrockshader.links.new(color_ramp_002_2.outputs[0], mix_003_4.inputs[0])
    moonrockshader.links.new(
        hue_saturation_value_4.outputs[0], principled_bsdf_4.inputs[2]
    )
    moonrockshader.links.new(color_ramp_1.outputs[0], mix_3.inputs[6])
    moonrockshader.links.new(mix_3.outputs[2], color_ramp_004_1.inputs[0])
    moonrockshader.links.new(mapping_001_2.outputs[0], noise_texture_003_1.inputs[0])
    moonrockshader.links.new(bump_4.outputs[0], bump_001_4.inputs[3])
    moonrockshader.links.new(mix_3.outputs[2], mix_001_4.inputs[0])
    moonrockshader.links.new(mapping_001_2.outputs[0], noise_texture_4.inputs[0])
    moonrockshader.links.new(geometry.outputs[7], color_ramp_002_2.inputs[0])
    moonrockshader.links.new(mix_3.outputs[2], bump_001_4.inputs[2])
    moonrockshader.links.new(noise_texture_4.outputs[0], color_ramp_1.inputs[0])
    moonrockshader.links.new(texture_coordinate_001.outputs[3], mapping_001_2.inputs[0])
    moonrockshader.links.new(principled_bsdf_4.outputs[0], group_output_6.inputs[0])
    moonrockshader.links.new(group_input_6.outputs[0], mapping_001_2.inputs[3])
    moonrockshader.links.new(group_input_6.outputs[1], mix_001_4.inputs[6])
    moonrockshader.links.new(group_input_6.outputs[2], mix_001_4.inputs[7])
    moonrockshader.links.new(group_input_6.outputs[3], mix_003_4.inputs[7])
    moonrockshader.links.new(group_input_6.outputs[5], noise_texture_4.inputs[3])
    moonrockshader.links.new(group_input_6.outputs[6], noise_texture_4.inputs[4])
    moonrockshader.links.new(group_input_6.outputs[5], noise_texture_001_3.inputs[3])
    moonrockshader.links.new(group_input_6.outputs[6], noise_texture_001_3.inputs[4])
    moonrockshader.links.new(group_input_6.outputs[9], hue_saturation_value_4.inputs[2])
    moonrockshader.links.new(group_input_6.outputs[11], bump_4.inputs[0])
    moonrockshader.links.new(group_input_6.outputs[10], noise_texture_003_1.inputs[2])
    moonrockshader.links.new(group_input_6.outputs[12], bump_001_4.inputs[0])
    moonrockshader.links.new(group_input_6.outputs[4], noise_texture_001_3.inputs[2])
    moonrockshader.links.new(group_input_6.outputs[14], mix_3.inputs[0])
    moonrockshader.links.new(group_input_6.outputs[4], math_3.inputs[0])
    moonrockshader.links.new(math_3.outputs[0], noise_texture_4.inputs[2])
    moonrockshader.links.new(group_input_6.outputs[15], noise_texture_003_1.inputs[4])
    moonrockshader.links.new(group_001_4.outputs[4], noise_texture_001_3.inputs[1])
    moonrockshader.links.new(group_001_4.outputs[3], noise_texture_4.inputs[1])
    moonrockshader.links.new(group_001_4.outputs[1], noise_texture_003_1.inputs[1])
    moonrockshader.links.new(bump_001_4.outputs[0], principled_bsdf_4.inputs[5])
    moonrockshader.links.new(noise_texture_003_1.outputs[0], bump_4.inputs[2])
    moonrockshader.links.new(mapping_001_2.outputs[0], voronoi_texture_4.inputs[0])
    moonrockshader.links.new(group_001_4.outputs[1], voronoi_texture_4.inputs[1])
    moonrockshader.links.new(color_ramp_005_1.outputs[0], bump_002_3.inputs[2])
    moonrockshader.links.new(bump_002_3.outputs[0], bump_4.inputs[3])
    moonrockshader.links.new(voronoi_texture_4.outputs[0], color_ramp_005_1.inputs[0])
    moonrockshader.links.new(group_input_6.outputs[16], voronoi_texture_4.inputs[2])
    moonrockshader.links.new(mapping_001_2.outputs[0], voronoi_texture_001_2.inputs[0])
    moonrockshader.links.new(group_001_4.outputs[1], voronoi_texture_001_2.inputs[1])
    moonrockshader.links.new(math_001_1.outputs[0], voronoi_texture_001_2.inputs[2])
    moonrockshader.links.new(
        voronoi_texture_001_2.outputs[0], color_ramp_006_1.inputs[0]
    )
    moonrockshader.links.new(group_input_6.outputs[16], math_001_1.inputs[0])
    moonrockshader.links.new(color_ramp_006_1.outputs[0], bump_003_1.inputs[2])
    moonrockshader.links.new(bump_003_1.outputs[0], bump_002_3.inputs[3])
    moonrockshader.links.new(map_range_004_2.outputs[0], mapping_001_2.inputs[1])
    moonrockshader.links.new(group_001_4.outputs[0], map_range_004_2.inputs[0])
    moonrockshader.links.new(group_002.outputs[0], math_002.inputs[1])
    moonrockshader.links.new(group_input_6.outputs[17], math_002.inputs[0])
    moonrockshader.links.new(math_002.outputs[0], bump_003_1.inputs[0])
    moonrockshader.links.new(group_001_4.outputs[2], group_002.inputs[0])
    ...
    moonrockshader.links.new(group_input_6.outputs[17], math_004.inputs[0])
    moonrockshader.links.new(group_002.outputs[2], math_004.inputs[1])
    moonrockshader.links.new(math_004.outputs[0], bump_002_3.inputs[0])
...
def marsrockshader_node_group():
    marsrockshader = bpy.data.node_groups.new(
        type="ShaderNodeTree", name="MarsRockShader"
    )
    ...
    shader_socket_3 = marsrockshader.interface.new_socket(
        name="Shader", in_out="OUTPUT", socket_type="NodeSocketShader"
    )
    shader_socket_3.attribute_domain = "POINT"

    group_output_7 = marsrockshader.nodes.new("NodeGroupOutput")
    ...
    noise_texture_003_2 = marsrockshader.nodes.new("ShaderNodeTexNoise")
    ...
    color_ramp_004_2 = marsrockshader.nodes.new("ShaderNodeValToRGB")
    ...
    noise_texture_005_1 = marsrockshader.nodes.new("ShaderNodeTexNoise")
    ...
    color_ramp_006_2 = marsrockshader.nodes.new("ShaderNodeValToRGB")
    ...
    marsrockshader.links.new(color_ramp_004_2.outputs[0], mix_shader_001.inputs[0])
    marsrockshader.links.new(mix_shader_001.outputs[0], mix_shader_002.inputs[2])
    marsrockshader.links.new(color_ramp_006_2.outputs[0], mix_shader_002.inputs[0])
    marsrockshader.links.new(
    ...
    marsrockshader.links.new(noise_texture_003_2.outputs[0], color_ramp_004_2.inputs[0])
    marsrockshader.links.new(mapping_001_3.outputs[0], noise_texture_003_2.inputs[0])
    marsrockshader.links.new(map_range_002.outputs[0], noise_texture_003_2.inputs[2])
    ...
    marsrockshader.links.new(noise_texture_005_1.outputs[0], color_ramp_006_2.inputs[0])
    marsrockshader.links.new(combine_color_002.outputs[0], group_005.inputs[4])
    marsrockshader.links.new(mapping_001_3.outputs[0], noise_texture_005_1.inputs[0])
    marsrockshader.links.new(map_range_007.outputs[0], noise_texture_005_1.inputs[2])
    marsrockshader.links.new(combine_color_001.outputs[0], group_006.inputs[3])
    marsrockshader.links.new(mix_shader_002.outputs[0], group_output_7.inputs[0])
...
def marssurfaceshader_node_group():
    marssurfaceshader = bpy.data.node_groups.new(
        type="ShaderNodeTree", name="MarsSurfaceShader"
    )
    ...
    shader_socket_4 = marssurfaceshader.interface.new_socket(
        name="Shader", in_out="OUTPUT", socket_type="NodeSocketShader"
    )
    ...
    group_1.name = "Group"
    group_1.node_tree = marsrockshader
    ...
    marssurfaceshader.links.new(
        map_range_007_1.outputs[0], noise_texture_005_2.inputs[2]
    )
    ...
    marssurfaceshader.links.new(
        map_range_005_1.outputs[0], combine_color_001_1.inputs[2]
    )
    marssurfaceshader.links.new(color_ramp_006_3.outputs[0], mix_001_5.inputs[7])
    marssurfaceshader.links.new(
        map_range_006_1.outputs[0], combine_color_002_1.inputs[2]
    )
    ...
    marssurfaceshader.links.new(
        noise_texture_003_3.outputs[0], color_ramp_004_3.inputs[0]
    )
    ...
    marssurfaceshader.links.new(
        map_range_002_1.outputs[0], noise_texture_003_3.inputs[2]
    )
    ...
    marssurfaceshader.links.new(
        noise_texture_005_2.outputs[0], color_ramp_006_3.inputs[0]
    )
