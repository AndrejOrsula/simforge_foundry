...
def moonrockshader_node_group():
    ...
    scale_socket = moonrockshader.interface.new_socket(
    ...
    noise_scale_socket = moonrockshader.interface.new_socket(
    ...
    roughness_socket = moonrockshader.interface.new_socket(
...
def moonrockmat_node_group():
    ...
    group_006.inputs[1].default_value = (
        0.24619978666305542,
        0.24620160460472107,
        0.2462015002965927,
        1.0,
    )
    group_006.inputs[2].default_value = (
        0.005181482061743736,
        0.005181520711630583,
        0.005181518383324146,
        1.0,
    )
    group_006.inputs[3].default_value = (
        0.4000000059604645,
        0.4000000059604645,
        0.4000000059604645,
        1.0,
