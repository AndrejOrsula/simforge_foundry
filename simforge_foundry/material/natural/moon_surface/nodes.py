...
def moonrockshader_node_group():
    ...
    bsdf_socket_3 = moonrockshader.interface.new_socket(
        name="BSDF", in_out="OUTPUT", socket_type="NodeSocketShader"
    )
    ...
    noise_scale_socket_1 = moonrockshader.interface.new_socket(
    ...
    noise_bump_strength_socket = moonrockshader.interface.new_socket(
    ...
    group_output_7 = moonrockshader.nodes.new("NodeGroupOutput")
    group_output_7.name = "Group Output"
    group_output_7.is_active_output = True

    group_input_7 = moonrockshader.nodes.new("NodeGroupInput")
    ...
    color_ramp_2 = moonrockshader.nodes.new("ShaderNodeValToRGB")
    ...
    color_ramp_001_4 = moonrockshader.nodes.new("ShaderNodeValToRGB")
    ...
    mix_003_3 = moonrockshader.nodes.new("ShaderNodeMix")
    ...
    bump_001_3 = moonrockshader.nodes.new("ShaderNodeBump")
    ...
    hue_saturation_value_3 = moonrockshader.nodes.new("ShaderNodeHueSaturation")
    ...
    math_4 = moonrockshader.nodes.new("ShaderNodeMath")
    math_4.name = "Math"
    ...
    math_001_2 = moonrockshader.nodes.new("ShaderNodeMath")
    ...
    map_range_004_4 = moonrockshader.nodes.new("ShaderNodeMapRange")
    ...
    math_002_1 = moonrockshader.nodes.new("ShaderNodeMath")
    math_002_1.name = "Math.002"
    math_002_1.operation = "MULTIPLY"
    math_002_1.use_clamp = False

    math_003_1 = moonrockshader.nodes.new("ShaderNodeMath")
    ...
    moonrockshader.links.new(mapping_001.outputs[0], noise_texture_001_3.inputs[0])
    moonrockshader.links.new(noise_texture_001_3.outputs[0], color_ramp_001_4.inputs[0])
    moonrockshader.links.new(color_ramp_001_4.outputs[0], mix_2.inputs[7])
    moonrockshader.links.new(
        color_ramp_004_1.outputs[0], hue_saturation_value_3.inputs[4]
    )
    moonrockshader.links.new(mix_001_4.outputs[2], mix_003_3.inputs[6])
    moonrockshader.links.new(mix_003_3.outputs[2], principled_bsdf_4.inputs[0])
    moonrockshader.links.new(color_ramp_002_2.outputs[0], mix_003_3.inputs[0])
    moonrockshader.links.new(
        hue_saturation_value_3.outputs[0], principled_bsdf_4.inputs[2]
    )
    moonrockshader.links.new(color_ramp_2.outputs[0], mix_2.inputs[6])
    moonrockshader.links.new(mix_2.outputs[2], color_ramp_004_1.inputs[0])
    moonrockshader.links.new(mapping_001.outputs[0], noise_texture_003_1.inputs[0])
    moonrockshader.links.new(bump_4.outputs[0], bump_001_3.inputs[3])
    moonrockshader.links.new(mix_2.outputs[2], mix_001_4.inputs[0])
    moonrockshader.links.new(mapping_001.outputs[0], noise_texture_4.inputs[0])
    moonrockshader.links.new(geometry.outputs[7], color_ramp_002_2.inputs[0])
    moonrockshader.links.new(mix_2.outputs[2], bump_001_3.inputs[2])
    moonrockshader.links.new(noise_texture_4.outputs[0], color_ramp_2.inputs[0])
    moonrockshader.links.new(texture_coordinate_001.outputs[3], mapping_001.inputs[0])
    moonrockshader.links.new(principled_bsdf_4.outputs[0], group_output_7.inputs[0])
    moonrockshader.links.new(group_input_7.outputs[0], mapping_001.inputs[3])
    moonrockshader.links.new(group_input_7.outputs[1], mix_001_4.inputs[6])
    moonrockshader.links.new(group_input_7.outputs[2], mix_001_4.inputs[7])
    moonrockshader.links.new(group_input_7.outputs[3], mix_003_3.inputs[7])
    moonrockshader.links.new(group_input_7.outputs[5], noise_texture_4.inputs[3])
    moonrockshader.links.new(group_input_7.outputs[6], noise_texture_4.inputs[4])
    moonrockshader.links.new(group_input_7.outputs[5], noise_texture_001_3.inputs[3])
    moonrockshader.links.new(group_input_7.outputs[6], noise_texture_001_3.inputs[4])
    moonrockshader.links.new(group_input_7.outputs[9], hue_saturation_value_3.inputs[2])
    moonrockshader.links.new(group_input_7.outputs[11], bump_4.inputs[0])
    moonrockshader.links.new(group_input_7.outputs[10], noise_texture_003_1.inputs[2])
    moonrockshader.links.new(group_input_7.outputs[12], bump_001_3.inputs[0])
    moonrockshader.links.new(group_input_7.outputs[4], noise_texture_001_3.inputs[2])
    moonrockshader.links.new(group_input_7.outputs[14], mix_2.inputs[0])
    moonrockshader.links.new(group_input_7.outputs[4], math_4.inputs[0])
    moonrockshader.links.new(math_4.outputs[0], noise_texture_4.inputs[2])
    moonrockshader.links.new(group_input_7.outputs[15], noise_texture_003_1.inputs[4])
    ...
    moonrockshader.links.new(bump_001_3.outputs[0], principled_bsdf_4.inputs[5])
    moonrockshader.links.new(noise_texture_003_1.outputs[0], bump_4.inputs[2])
    moonrockshader.links.new(mapping_001.outputs[0], voronoi_texture_4.inputs[0])
    ...
    moonrockshader.links.new(group_input_7.outputs[16], voronoi_texture_4.inputs[2])
    moonrockshader.links.new(mapping_001.outputs[0], voronoi_texture_001_1.inputs[0])
    moonrockshader.links.new(group_001_4.outputs[1], voronoi_texture_001_1.inputs[1])
    moonrockshader.links.new(math_001_2.outputs[0], voronoi_texture_001_1.inputs[2])
    moonrockshader.links.new(
        voronoi_texture_001_1.outputs[0], color_ramp_006_1.inputs[0]
    )
    moonrockshader.links.new(group_input_7.outputs[16], math_001_2.inputs[0])
    ...
    moonrockshader.links.new(map_range_004_4.outputs[0], mapping_001.inputs[1])
    moonrockshader.links.new(group_001_4.outputs[0], map_range_004_4.inputs[0])
    moonrockshader.links.new(group_002.outputs[0], math_002_1.inputs[1])
    moonrockshader.links.new(group_input_7.outputs[17], math_002_1.inputs[0])
    moonrockshader.links.new(math_002_1.outputs[0], bump_003_1.inputs[0])
    moonrockshader.links.new(group_001_4.outputs[2], group_002.inputs[0])
    moonrockshader.links.new(math_003_1.outputs[0], math_001_2.inputs[1])
    moonrockshader.links.new(group_002.outputs[1], math_003_1.inputs[0])
    moonrockshader.links.new(group_input_7.outputs[17], math_004.inputs[0])
...
def moonsurfaceshader_node_group():
    moonsurfaceshader = bpy.data.node_groups.new(
        type="ShaderNodeTree", name="MoonSurfaceShader"
    )
    ...
    shader_socket_1 = moonsurfaceshader.interface.new_socket(
        name="Shader", in_out="OUTPUT", socket_type="NodeSocketShader"
    )
    ...
    moonsurfaceshader.links.new(
        texture_coordinate_001_1.outputs[3], mapping_001_1.inputs[0]
    )
    ...
    moonsurfaceshader.links.new(
        noise_texture_004_1.outputs[0], mix_shader_002.inputs[0]
    )
    ...
    moonsurfaceshader.links.new(
        noise_texture_002_1.outputs[0], color_ramp_003_1.inputs[0]
    )
