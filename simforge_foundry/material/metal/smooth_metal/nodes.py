...
def smooth_metal_node_group():
    ...
    shader_socket = smooth_metal.interface.new_socket(
        name="Shader", in_out="OUTPUT", socket_type="NodeSocketShader"
    )
    shader_socket.attribute_domain = "POINT"

    scale_socket = smooth_metal.interface.new_socket(
    ...
    base_color_socket = smooth_metal.interface.new_socket(
    ...
    metallic_socket = smooth_metal.interface.new_socket(
    ...
    detail_socket = smooth_metal.interface.new_socket(
    ...
    roughness_socket = smooth_metal.interface.new_socket(
    ...
    bump_strength_socket = smooth_metal.interface.new_socket(
