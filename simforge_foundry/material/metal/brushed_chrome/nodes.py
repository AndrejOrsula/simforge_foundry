...
def brushedchrome_node_group():
    brushedchrome = bpy.data.node_groups.new(
        type="ShaderNodeTree", name="BrushedChrome"
    )
    ...
    shader_socket = brushedchrome.interface.new_socket(
        name="Shader", in_out="OUTPUT", socket_type="NodeSocketShader"
    )
    shader_socket.attribute_domain = "POINT"

    scale_socket = brushedchrome.interface.new_socket(
    ...
    base_color_socket = brushedchrome.interface.new_socket(
    ...
    metallic_socket = brushedchrome.interface.new_socket(
    ...
    detail_1_socket = brushedchrome.interface.new_socket(
    ...
    detail_2_socket = brushedchrome.interface.new_socket(
    ...
    roughness_socket = brushedchrome.interface.new_socket(
    ...
    bump_strength_socket = brushedchrome.interface.new_socket(
    ...
    rotation_socket = brushedchrome.interface.new_socket(
        name="Rotation", in_out="INPUT", socket_type="NodeSocketVector"
    )
    rotation_socket.default_value = (0.0, 0.0, 0.0)
    rotation_socket.min_value = -3.4028234663852886e38
    rotation_socket.max_value = 3.4028234663852886e38
    rotation_socket.subtype = "EULER"
    rotation_socket.attribute_domain = "POINT"

    clear_coat_weight_socket = brushedchrome.interface.new_socket(
        name="Clear Coat Weight", in_out="INPUT", socket_type="NodeSocketFloat"
    )
    ...
    clear_coat_roughness_socket = brushedchrome.interface.new_socket(
        name="Clear Coat Roughness", in_out="INPUT", socket_type="NodeSocketFloat"
    )
    ...
    clear_coat_tint_socket = brushedchrome.interface.new_socket(
        name="Clear Coat Tint", in_out="INPUT", socket_type="NodeSocketColor"
    )
