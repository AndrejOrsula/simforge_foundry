...
def goldsmoothshader_node_group():
    goldsmoothshader = bpy.data.node_groups.new(
        type="ShaderNodeTree", name="GoldSmoothShader"
    )
    ...
    bsdf_socket = goldsmoothshader.interface.new_socket(
